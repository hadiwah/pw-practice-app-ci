...
test('lists and dropdowns', async({page}) => {
    ...
    page.getByRole('listitem') //whenthe list has LI tag
...
test('datepicker', async({page}) => {
    ...
    await page.locator('[class="today day-cell ng-star-inserted"]').getByText(expectedDate, {exact: true}).click()
